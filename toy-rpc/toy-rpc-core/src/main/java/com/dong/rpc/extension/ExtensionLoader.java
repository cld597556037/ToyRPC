...
public class ExtensionLoader<T> {
    ...
    public T getExtension(String name) throws ToyException {
        if (!init) {
            init();
        }
        ...
        try {
            ...
            if (instances.containsKey(name)) {
                ...
                T instance = classes.get(name).newInstance();
                instances.putIfAbsent(name, instance);
                return instance;
            }
        } catch (Exception e) {
            throw new ToyException("fail to get extension instance of :" + name, e);
        }
        return null;
    }
